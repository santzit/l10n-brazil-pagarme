...
class PaymentProvider(models.Model):
    ...
    # Note: Partner name population is now handled by JavaScript in _prepareInlineForm
    # This ensures the name is fetched and populated when the form is actually loaded
